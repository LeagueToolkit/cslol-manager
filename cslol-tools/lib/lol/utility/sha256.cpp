...
namespace sha2 {
    ...
    private:
        ...
        static inline constexpr uint_t CH(uint_t x, uint_t y, uint_t z) noexcept { return (x & y) ^ (~x & z); }
...
void lol::utility::sha256(const void* data, size_t size, void* out) {
    sha2::SHA256((const char*)data, size, (uint8_t*)out);
}
